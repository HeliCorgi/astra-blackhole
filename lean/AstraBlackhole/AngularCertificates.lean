...
theorem p4_low_moments :
    evenMoment p4 0 = 0 ∧ evenMoment p4 1 = 0 := ⟨rfl, rfl⟩

theorem p4_first_visible : evenMoment p4 2 = 8/315 := rfl

theorem p6_low_moments :
    evenMoment p6 0 = 0 ∧ evenMoment p6 1 = 0 ∧
    evenMoment p6 2 = 0 := ⟨rfl, rfl, rfl⟩

theorem p6_first_visible : evenMoment p6 3 = 16/3003 := rfl

theorem p8_low_moments :
    evenMoment p8 0 = 0 ∧ evenMoment p8 1 = 0 ∧
    evenMoment p8 2 = 0 ∧ evenMoment p8 3 = 0 := ⟨rfl, rfl, rfl, rfl⟩

theorem p8_first_visible : evenMoment p8 4 = 128/109395 := rfl
