...
### KS量子監査：clock / KG同一状態 / ordering / mass-curvature domain

[詳細](docs/KS_QUANTUM_AUDIT_ja.md) / [machine-readable obligations](audit/ks_black_hole_obligations.json) / [保存要約](research/ks_black_hole_audit_results/summary.json)
